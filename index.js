...
const unfundedGamesString = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently,
 ${unfundedGamesCount === 1 ? '1 game' : unfundedGamesCount + ' games'} remain unfunded. We need your help to fund these amazing games!`;
